...
export const backendOperations={
  ...
  state:(token,{productCode})=>crmRpc('crm_frontend_state_fast_v4',{p_product_code:productCode},token),
  companyBundle:(token,{productCode,companyId})=>crmRpc('crm_frontend_company_bundle_v3',{p_product_code:productCode,p_company_id:companyId},token),
  ...
  recordEvent:(token,payload)=>crmRpc('crm_frontend_record_event_v2',payload,token),
  updateEvent:(token,payload)=>crmRpc('crm_frontend_update_event_v3',payload,token),
